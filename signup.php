...
if (isset($_POST["submit"])) {
    ...
    if ($row > 0) {
        echo "<script>alert('Email id already exist with another account. Please try with other email id');</scipt>";
    } else {
        $msg = mysqli_query($conn, "insert into users(fname,lname,email,password,contact)values('$fname','$lname','$email','$password','$contact')");
        if ($msg) {
                                    ...
                                    <form name="signup" method="post" onsubmit="return checkpass();">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-12 mt-3">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="email" name="email" type="email" placeholder="aman@gmail.com" required />
                                            ...
                                            <div class="col-md-6 ">
                                            <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="password" name="password" type="password" placeholder="Create a password" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{" title="at least one number and one uppercase and lowercase letter , and at least 6 or more characters" />
